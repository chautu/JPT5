                    ...
                    <div className="row align-items-end">
                      <div className="col-md-6">
                        <div className="form-group">
                          <label className="firstname">Firt Name</label>
                          <input
                            type="text"
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label className="country">State / Country</label>
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          <label className="towncity">Town / City</label>
                          <input
                            type="text"
                            className="form-control"
                            placeholder=""
